...
void fillLEDsFromPaletteColors()
{
    ...
    for( int i = 0; i < NUM_LEDS; i++) {
            //leds[i] = ColorFromPalette(currentPalette, colorIndex, BRIGHTNESS, currentBlending);  //comment out to enable rainbow effect
            leds[i] = CRGB(0,0,0); // comment in to disable rainbow effect
            //colorIndex += 3;
        }
